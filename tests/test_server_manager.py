...
SERVERS = [
    {
        ...
        "EntryCountry": "PT",
        "ExitCountry": "PT",
        "Domain": "pt-05.protonvpn.com",
        "Tier": 1,
        "Features": 0,
        "Region": "null",
        "City": "Lisbon",
        "ID": "m3-9M9TDapzElDMw5VO28-9DhaA0r1XXdPjg0MM"
        + "Nb5ki7cmEosVFf0metcsHchD8E98BQpiV_9QfmyXgqaQQ7Q==",
        "Location": {
            "Lat": 38.72,
            "Long": -9.13
        },
        ...
        [
            {
                "EntryIP": "195.158.248.227",
                "ExitIP": "195.158.248.227",
                "Domain": "pt-05.protonvpn.com", "ID":
                "2-NIsqlNbgq1R3qf-HYdVCOm4essypLJf7Ui4XT-"
                + "LMPGnipRRJ8oB7zn9PzwEsdBXii0CWdm2sO3CiSD2NI9Pw==",
                "Status": 1
            }
        ],
...
class TestUnitServerManager:
    ...
    def test_get_correct_ip_list(self):
        self.server_man.get_ip_list("test#2", SERVERS)

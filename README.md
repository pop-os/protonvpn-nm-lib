...
|Ubuntu/Linux Mint/Debian and derivatives | `sudo apt install -y network-manager network-manager-openvpn openvpn python3-pip python3-xdg python3-keyring python3-jinja2 python3-dialog python3-distro gir1.2-nm-1.0 libsecret-tools dbus-x11 gnome-keyring` |
|OpenSUSE/SLES                            | To-do

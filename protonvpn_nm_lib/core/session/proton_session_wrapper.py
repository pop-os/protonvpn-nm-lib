...
class ProtonSessionWrapper:
    ...
    def __init__(
        ...
        self.keyring_session = kwargs.pop("keyring_session")
    ...
    def store_server_cache(
        ...
        newly_cached_servers = {
            ...
            for server
            in ServerList.load_servers_from_dict(new_cache).servers
        }

        for server in locally_cached_servers.servers:
    ...
    @staticmethod
    def load(dump, keyring_session, TLSPinning=True):
        ...
        proton_session_wrapper = ProtonSessionWrapper(
            ...
            keyring_session=keyring_session
        )
    ...
    def handle_401(self, error, method, *args, **kwargs):
        ...
        self.keyring_session.store(self.proton_session.dump())
